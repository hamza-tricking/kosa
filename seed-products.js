...
const products = [
  ...
  },
  {
    ...
    details: {
      ...
      usage: {
        routine: "قطرات بسيطة تدلك على البشرة أو الشعر قبل النوم.",
        tip: "يُستخدم يومياً للحصول على أفضل النتائج.",
        bestTime: "قبل النوم."
      }
    }
  },
  {
    ...
    details: {
      ...
      usage: {
        routine: "يُدهن على وجه نظيف قبل النوم يومياً.",
        tip: "يُترك لمدة 30 دقيقة قبل غسله.",
        bestTime: "قبل النوم."
      }
    }
  },
  {
    ...
    details: {
      ...
      usage: {
        routine: "تخلط مع الزبادي أو ماء الورد كقناع لمدة 20 دقيقة.",
        tip: "يُغسل بالماء الفاتر بعد الاستخدام.",
        bestTime: "مرتين أسبوعياً."
      }
    }
  },
  {
    ...
    details: {
      ...
      usage: {
        routine: 'ضع كمية صغيرة ودلّك بلطف 2 – 3 مرات يوميًا عند الحاجة.',
        tip: 'لا يوضع على الجروح المفتوحة ويُتجنب ملامسة العينين.',
        bestTime: 'عند الشعور بالألم.'
      }
    }
  }
];
